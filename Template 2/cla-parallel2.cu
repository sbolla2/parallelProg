...
#define num_blocks (bits + block_size + 1)/block_size
...
void cla()
{
  ...
  /***********************************************************************************************************/
    compute_gp<<<num_blocks, block_size>>>();
    compute_group_gp<<<num_blocks, block_size>>>();
    compute_section_gp<<<num_blocks, block_size>>>();
    compute_super_section_gp<<<num_blocks, block_size>>>();
    compute_super_super_section_gp<<<num_blocks, block_size>>>();
    compute_super_super_section_carry<<<num_blocks, block_size>>>();
    compute_super_section_carry<<<num_blocks, block_size>>>();
    compute_section_carry<<<num_blocks, block_size>>>();
    compute_group_carry<<<num_blocks, block_size>>>();
    compute_carry<<<num_blocks, block_size>>>();
    compute_sum<<<num_blocks, block_size>>>();
